...
export interface StorageInterface extends Interface {
  ...
  getEvent(nameOrSignatureOrTopic: "StoreEvent"): EventFragment;
...
export namespace StoreEventEvent {
...
export interface Storage extends BaseContract {
  ...
  getEvent(
    ...
    StoreEventEvent.InputTuple,
    StoreEventEvent.OutputTuple,
    StoreEventEvent.OutputObject
  >;

  filters: {
    "StoreEvent(address)": TypedContractEvent<
      StoreEventEvent.InputTuple,
      StoreEventEvent.OutputTuple,
      StoreEventEvent.OutputObject
    >;
    StoreEvent: TypedContractEvent<
      StoreEventEvent.InputTuple,
      StoreEventEvent.OutputTuple,
      StoreEventEvent.OutputObject
    >;
